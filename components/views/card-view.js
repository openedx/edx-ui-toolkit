...
;(function (define) {
    ...
    define(['jquery',
            'underscore',
            'backbone',
            'text!templates/views/card-view/basic-card-view.underscore',
            'text!templates/views/card-view/square-card-view.underscore'],
        function ($, _, Backbone, basicCardViewTemplate, squareCardViewTemplate) {
            var CardView = Backbone.View.extend({
                ...
                render: function () {
                    var maxLength = 72,
                        ...
                        template = _.template(
                            configuration === 'square-card' ? squareCardViewTemplate : basicCardViewTemplate
                        );
